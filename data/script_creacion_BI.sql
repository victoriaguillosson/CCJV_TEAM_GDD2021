...
DECLARE @grupo VARCHAR(50)= 'CFJV_TEAM'
EXEC checkProced @grupo,'completarDimensiones'
GO
...
SELECT @SQL = 'INSERT INTO CFJV_TEAM.BI_CLIENTE (CLIENTE_DNI,CLIENTE_APELLIDO,CLIENTE_NOMBRE,CLIENTE_DIRECCION,CLIENTE_EDAD,CLASIFICACION_EDAD)
