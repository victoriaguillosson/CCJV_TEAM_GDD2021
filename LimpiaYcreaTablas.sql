...
INSERT INTO NOM_GRUPO.Microprocesador (microprocesador_codigo,microprocesador_cache,microprocesador_cant_hilos,microprocesador_velocidad,fabricante_id)
	SELECT DISTINCT m.MICROPROCESADOR_CODIGO, m.MICROPROCESADOR_CACHE, m.MICROPROCESADOR_CANT_HILOS,m.MICROPROCESADOR_VELOCIDAD, (SELECT TOP 1 f.fabricante_id FROM NOM_GRUPO.Fabricante f WHERE f.nombre=m.MICROPROCESADOR_FABRICANTE)
	FROM gd_esquema.Maestra m
